    ...
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-brand-linen px-4">
      <div className="w-full max-w-sm rounded-lg bg-white p-8 shadow-lg">
        ...
        {oauthMethods.length > 0 && localMethod && (
          <div className="my-5 flex items-center gap-3 text-xs uppercase tracking-wide text-brand-gray/60">
          ...
          <form onSubmit={handleLocalSubmit} className="flex flex-col gap-3">
            ...
            <p className="text-center text-sm">
              <Link
                ...
                className="text-brand-gray hover:text-brand-navy hover:underline"
              >
                Forgot password?
              </Link>
            </p>
      ...
      {PRODUCT.attribution ? (
        <a
          ...
          className="text-xs text-brand-gray/70 transition-colors hover:text-brand-gray"
        >
          {PRODUCT.attribution}
        </a>
      ) : null}
