    ...
    <div className="space-y-6 font-serif">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <Link
          ...
          className="inline-flex min-h-[44px] items-center gap-2 rounded-lg bg-brand-navy px-5 py-2 text-sm font-semibold text-white transition hover:bg-brand-blue"
        >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-brand-gray/20 bg-brand-linen">
                <th className="px-4 py-3 text-left font-semibold text-brand-gray">Invoice</th>
                <th className="px-4 py-3 text-left font-semibold text-brand-gray">Customer</th>
                <th className="px-4 py-3 text-left font-semibold text-brand-gray">Date</th>
                <th className="px-4 py-3 text-left font-semibold text-brand-gray">Due</th>
                <th className="px-4 py-3 text-right font-semibold text-brand-gray">Total</th>
                <th className="px-4 py-3 text-right font-semibold text-brand-gray">Open</th>
